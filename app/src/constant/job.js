...
const experinceLevel = [
    ...
    {label: "More than 3 year", value: "more than 3 year"},
...
const jobCategories = [
    ...
    {label: "IT & Telecommunication", value: "IT & Telecommunication"},
    {label: "Marketing / Advertising / Customer Service", value: "Marketing / Advertising / Customer Service"},
    {label: "Customer Support", value: "Customer Support"},
    {label: "Sales / Public Relations", value: "Sales / Public Relations"},
    {label: "General Mgmt. / Administration / Operations", value: "SGeneral Mgmt. / Administration / Operations"},
